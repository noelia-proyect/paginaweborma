...
$xLogin_datosOperador = "''";
if (isset($_SESSION['MM_Username'])) {
  $xLogin_datosOperador = $_SESSION['MM_Username'];
}
$xNivel_datosOperador = "''";
if (isset($_SESSION['MM_UserGroup'])) {
  $xNivel_datosOperador = $_SESSION['MM_UserGroup'];
}

$query_datosOperador = sprintf("SELECT codoper, nombre, tipo  FROM operadores WHERE login=%s AND tipo=%s AND estado='A'", GetSQLValueString($xLogin_datosOperador, "text"),GetSQLValueString($xNivel_datosOperador, "text"));
//SELECT codoper, nombre, tipo FROM operadores WHERE login='admin' AND tipo='A' AND estado='A';
//var_dump($query_datosOperador); die("HHHHH");

$datosOperador = $cnx->query($query_datosOperador);
$row_datosOperador = $datosOperador->fetch_assoc();
$totalRows_datosOperador = $datosOperador->num_rows;

if(isset($_SESSION['MM_Username']) && isset($_SESSION['MM_UserGroup'])){
	if($totalRows_datosOperador===1){

		//var_dump($_SESSION); die();
		$codOp=$row_datosOperador['codoper'];
		$napOp=$row_datosOperador['nombre'];
		$sexOp=$row_datosOperador['tipo'];
		
		$_SESSION["codOp"]=$codOp;
		$_SESSION["napOp"]=$napOp;
		$_SESSION["sexOp"]=$sexOp;				
?>
...
-->
  ...
  <!-- BEGIN MENU -->
          ...
          <section id="titulo" >
            ...
            OFICINA DE REGISTRO MILITAR AREQUIPA
            </section>  
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">EXAMEN <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">             
                <li><a onClick="ver('','div','marco','xR/r001_examen.php');">REPORTE 01</a></li>
                <li><a onClick="ver('','div','marco','xR/r002_examen.php');">REPORTE 02</a></li>           
                <li><a onClick="ver('','section','marco','xR/r006_criterio_examen.php');">REPORTE 03</a></li>
                <li><a onClick="ver('','section','marco','xR/r007_criterio_examen.php');">REPORTE 04</a></li>
                <li><a onClick="ver('','section','marco','xR/r008_criterio_examen.php');">REPORTE 05</a></li>
                <li><a onClick="ver('','section','marco','xR/r009_criterios_examen.php');">REPORTE 06</a></li>
                <li><a onClick="ver('','section','marco','xR/r010_criterio_examen.php');">REPORTE 07</a></li>
              </ul>
            </li>

            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Registrar <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a onClick="ver('','section','marco','xM/operador_1registrar.php');" >Operadores</a></li>
                <li><a onClick="ver('','section','marco','xM/productos_1registrar.php');" >Productos</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Soporte <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a onClick="ver('','section','marco','xM/operador_2lista.php');" >Lista de operadores</a></li>
                <li><a onClick="ver('','section','marco','xM/productos_2lista.php');" >Lista de productos</a></li>
                
              </ul>
            </li>

            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Detalles <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a >Movimientos por fechas</a></li>
                <li><a >Movimientos por criterios</a></li>
                <li><a >Compras</a></li>
                <li><a >Ventas</a></li>
              </ul>
            </li>
  ...
  <!-- Start slider -->
  <section id="slider">
    <div class="main-slider" id="marco">
          ...
          <div class="latest-news-content">
            <div class="row">
              ...
              <div class="col-md-4">
                <article class="blog-news-single">
                  <div class="blog-news-img">
                    <a href="include/blog-single-with-right-sidebar.html"><img src="assets/images/blog-img-1.jpg" alt="image"></a>
                  </div>
                  <div class="blog-news-title">
                    <h2><a href="include/blog-single-with-right-sidebar.html">All about writing story</a></h2>
                  ...
                  <div class="blog-news-details">
                    ...
                    <a class="blog-more-btn" href="include/blog-single-with-right-sidebar.html">Read More <i class="fa fa-long-arrow-right"></i></a>
                  </div>
                </article>
              </div>
              <!-- start single latest news -->
              <div class="col-md-4">
                <article class="blog-news-single">
                  <div class="blog-news-img">
                    <a href="include/blog-single-with-right-sidebar.html"><img src="assets/images/blog-img-2.jpg" alt="image"></a>
                  </div>
                  <div class="blog-news-title">
                    <h2><a href="include/blog-single-with-right-sidebar.html">Best Mobile Device</a></h2>
                    <p>By <a class="blog-author" href="#">John Powell</a> <span class="blog-date">|18 October 2015</span></p>
                  </div>
                  <div class="blog-news-details">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the</p>
              ...
              <div class="col-md-4">
                <article class="blog-news-single">
                  <div class="blog-news-img">
                    <a href="include/blog-single-with-right-sidebar.html"><img src="assets/images/blog-img-3.jpg" alt="image"></a>
                  </div>
                  <div class="blog-news-title">
                    <h2><a href="include/blog-single-with-right-sidebar.html">Personal Note Details</a></h2>
                    <p>By <a class="blog-author" href="#">John Powell</a> <span class="blog-date">|18 October 2015</span></p>
                  </div>
                  <div class="blog-news-details">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the</p>
...
<?php
		...
		die('No se hallo al Usuario...O esta inhabilitado...('.$totalRows_datosOperador.')');
	}
}else{
	echo("Autenticacion incorrecto");	
};
?>